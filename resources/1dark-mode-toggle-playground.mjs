...
((doc) => {
  ...
  doc.addEventListener('colorschemechange', (e) => {
    ...
    icon.href = e.detail.colorScheme === 'dark' ? 'https://cdn.jsdelivr.net/gh/thedoggybrad/speedtest@main/resources/favicon.png' : 'https://cdn.jsdelivr.net/gh/thedoggybrad/speedtest@main/resources/favicon.png';
    console.log(
